...
Mahalanobis Distance or simply Mahalanobis D is a method for multivariate outlier detection. Careless responding is just one reason why a person's set of answers to a survey may make her an outlier. Mahalanobis D is thus not specifically adressed towards careless responding, but has been shown to be valuable for this problem.
